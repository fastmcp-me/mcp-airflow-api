"""
Airflow API v1 (2.x) MCP tools - AUTO GENERATED.

All original tools from airflow_api.py moved here for v1 API support.
"""
import os
import logging
from typing import Any, Dict, List, Optional

from ..functions import airflow_request_v1 as airflow_request, read_prompt_template, parse_prompt_sections, get_current_time_context, list_dags_internal, get_dag_detailed_info, PROMPT_TEMPLATE_PATH
